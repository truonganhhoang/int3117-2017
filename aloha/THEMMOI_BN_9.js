const delay = 2000
describe('THEMMOI_BN_9', function () {
  describe('Kiểm tra textbox họ tên', function () {
    ...
    describe('Kiểm tra tìm kiếm các ký tự đặc biệt', function(){
      ...
      it('Nhập dữ liệu trường họ tên là ký tự đặc biệt', function() {
        cy.get('div.col-xs-12.col-md-3').eq(0).find('input').type('%^&*()')
        ...
        cy.get('td.align-left.ng-binding').eq(1).should('contain', '%^&*()')
