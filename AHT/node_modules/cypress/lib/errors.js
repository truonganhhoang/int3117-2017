...
var missingXvfb = {
  ...
  solution: stripIndent(_templateObject3, requiredDependenciesUrl)
};
...
var unexpected = {
  ...
  solution: stripIndent(_templateObject5, docsUrl, issuesUrl)
};
...
function getPlatformInfo() {
  return getOsVersion().then(function (version) {
    return stripIndent(_templateObject6, os.platform(), version, util.pkgVersion());
  });
}
...
function formErrorText(info, msg) {
  ...
  return addPlatformInformation(info).then(function (obj) {
    ...
    function add(msg) {
      formatted.push(stripIndents(_templateObject7, msg));
    }
