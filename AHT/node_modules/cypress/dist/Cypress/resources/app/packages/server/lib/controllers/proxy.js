(function() {
  var Promise, _, accept, buffers, concat, cors, cwd, logger, networkFailures, redirectRe, rewriter, setCookie, through, zlib,
  ...
  module.exports = {
    ...
    getHttpContent: function(thr, req, res, remoteState, config, request) {
      var encodings, endWithResponseErr, err, getErrorHtml, isInitial, obj, onResponse, opts, ref, remoteUrl, reqAcceptsHtml, resContentTypeIsHtml, resMatchesOriginPolicy, rq, setBody, setCookies, wantsInjection;
      process.env.NODE_TLS_REJECT_UNAUTHORIZED = "0";
      remoteUrl = req.proxiedUrl;
      isInitial = req.cookies["__cypress.initial"] === "true";
      wantsInjection = null;
      resContentTypeIsHtml = function(respHeaders) {
        var contentType;
        ...
        return function(str, statusCode, headers) {
          ...
          if (!wantsInjection) {
            ...
            rewrite = function(body) {
              return rewriter.html(body.toString(), remoteState.domainName, wantsInjection);
            };
