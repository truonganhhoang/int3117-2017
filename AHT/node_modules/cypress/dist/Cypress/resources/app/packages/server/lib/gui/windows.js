(function() {
  var BrowserWindow, Promise, _, contextMenu, cwd, cyDesktop, extension, firstOrNull, getByType, getCookieUrl, getUrl, recentlyCreatedWindow, savedState, uri, user, windows;
  ...
  module.exports = {
    ...
    create: function(options) {
      ...
      if (ts = options.trackState) {
        this.trackState(options.projectPath, win, ts);
      }
      if (options.devTools) {
