(function() {
  ...
  module.exports = {
    ...
    waitForTestsToFinishRunning: function(options) {
      var cname, end, headed, name, outputPath, project, screenshots, started, videoCompression;
      if (options == null) {
        options = {};
      }
      project = options.project, headed = options.headed, screenshots = options.screenshots, started = options.started, end = options.end, name = options.name, cname = options.cname, videoCompression = options.videoCompression, outputPath = options.outputPath;
