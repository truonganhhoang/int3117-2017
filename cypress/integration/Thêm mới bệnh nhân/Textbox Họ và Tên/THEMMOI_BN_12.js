const delay = 2000
describe('THEMMOI_BN_12', function () {
  describe('Kiểm tra textbox họ tên', function () {
    ...
    describe('Kiểm tra Trim space', function(){
      ...
      it('Nhập có space ở đầu và cuối', function() {
        cy.get('div.col-xs-12.col-md-3').eq(0).find('input').type('   Aloha   ')
        ...
        cy.get('td.align-left.ng-binding').eq(1).should('not.contain', '   ')
