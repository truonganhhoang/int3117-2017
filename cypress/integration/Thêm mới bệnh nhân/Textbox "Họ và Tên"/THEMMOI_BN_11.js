const delay = 2000
describe('THEMMOI_BN_11', function () {
  describe('Kiểm tra textbox họ tên', function () {
    ...
    describe('Kiểm tra nhập thẻ html', function(){
      ...
      it('Nhập thẻ <b>', function() {
        cy.get('div.col-xs-12.col-md-3').eq(0).find('input').type('<b>Hello</b>')
        ...
        cy.get('td.align-left.ng-binding').eq(1).should('contain', '<b>Hello</b>')
