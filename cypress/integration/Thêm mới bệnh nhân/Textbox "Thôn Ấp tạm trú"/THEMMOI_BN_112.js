// author: NoBi
//dau space duoc trem o truong "ho va ten" va "thon ap tam tru"


var delay = 3000;
describe('Kiem tra chuc nang Trim Space', function () {
        ...
        it('Enter required field', function () {
            cy
                .get("label").contains("Họ và tên").parent()
                    .within(function () {
                        cy
                            .get("input").focus().type("    THEMMOI_BN_112    ")
                    })
                ...
                .get("label").contains("Số").parent()
                    .within(function () {
                         cy.get("input").focus().type("69696969696")
                    })
                ...
                .get("input[ng-model='patient.resident_hamlet']").focus().type("   abcxyz   ")
