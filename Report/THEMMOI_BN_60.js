//  Kiem tra chuc nang Trim space

describe('THEMMOI_BN_60', function(){ 
	...
	context('Window', function(){       
		...
		// Kiem tra Trim space
		it('THEMMOI_BN_60', function(){
			// Nhap du lieu Text box Noi gioi thieu gom nhieu space dau va cuoi cau.
			const test_string = '     The day you went away             '
			const result_string = 'The day you went away'
			cy.get('form .portlet-body').find('input[ng-model="patient.referral_agency"]').type(test_string)
			// Tao benh nhan
			...
			cy.get('.tab-content .tabbable-line').first().find('tr').eq(6).find('td').eq('1').should('contain',result_string)
