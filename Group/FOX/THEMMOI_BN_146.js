...
describe('THEMMOI_BN_146 Kiểm tra số lượng và sắp xếp các giá trị trong combo', function () {
	describe('Tài khoản bác sĩ', function () {
		...
		describe('Quản lý bệnh nhân > Thêm bệnh nhân', function () {
			it('Combo-box "Mối quan hệ"', function () {
				...
				cy.contains('div.form-group', 'Mối quan hệ').find('a.select2-choice').click();
