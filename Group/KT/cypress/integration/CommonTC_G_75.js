describe('Kiểm tra trường từ ngày nhỏ hơn trường đến ngày', function() {
  beforeEach(function(){
    cy.visit('signin')
  })

  var currentdate = new Date();
  var fromDate = currentdate.getDate() + '/' + currentdate.getMonth() + '/' + (currentdate.getFullYear() - 1)
  var toDate = currentdate.getDate() + '/' + currentdate.getMonth() + '/' + currentdate.getFullYear()
