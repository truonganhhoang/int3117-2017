describe('Common TC_GUI', function() {
  context('Validate du lieu truong so', function() {
    ...
    it('CommonTC_G_36', function(){
      cy.get("input[ng-model='new_prescription.dosage']").type(10)
      cy.get("input[ng-model='new_prescription.duration']").type(10.334666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666666)
