(function() {
  var _, anyUnderscoredValuePairs, backup, coerce, config, cwd, hasStrayEndQuote, minimist, normalizeBackslash, normalizeBackslashes, parseNestedValues, path, removeLastCharacter, whitelist,
    slice = [].slice;
