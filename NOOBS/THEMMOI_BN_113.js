// author: NoBi
//viet tieng viet co dau o truong "ho va ten"


var delay = 3000;
describe('Kiem tra khi du lieu la chu co dau', function () {
    describe('Use account agency', function () {
        ...
        it('Enter required field', function () {
            cy
                ...
                .within(function () {
                    cy
                        .get("input").focus().type("thêm mới bn 113")
                })
                ...
                .within(function () {
                    cy.get("input").focus().type("66996699666")
                })
